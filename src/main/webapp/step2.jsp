...
<%
	...
	if(true){
		...
		JSONObject jsonObj = new JSONObject("{\"cn\":[\"marcus.jorge\"],\"uidnumber\":[\"40272\"],\"employeetype\":[\"-\"],\"shadowmax\":[\"365\"],\"mail\":[\"avner.goncalves@s2it.com.br\"],\"uid\":[\"marcus.jorge\"],\"mobile\":[\"0\"],\"sn\":[\"Jorge\"],\"shadowlastchange\":[\"16120\"],\"shadowmin\":[\"1\"],\"homedirectory\":[\"\/home\/prod\/marcus.jorge\"],\"loginshell\":[\"\/bin\/bash\"],\"givenname\":[\"Marcus VinÃ¿Â­cius\"],\"employeenumber\":[\"1162\"],\"initials\":[\"Garcia\"],\"shadowwarning\":[\"30\"],\"street\":[\"---\"],\"homephone\":[\"(21) 2483-6657\"],\"description\":[\"infra\"],\"gidnumber\":[\"40272\"]}");
         	//
